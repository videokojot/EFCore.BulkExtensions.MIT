...
/// <summary> Provides a list of information for EFCore.BulkExtensions that is used internally to know what to do with the data source received </summary>
...
#pragma warning restore CS1591 // No XML comments required here.
...

    {
        ...
        List<IProperty> allProperties = new List<IProperty>();
    ...
    /// <summary> Validates the specified property list </summary>
    ...
    public async Task<MergeActionCounts> GetMergeActionCounts(DbContext context, bool isAsync, CancellationToken cancellationToken)
    {
        ...
        MergeActionCounts mergeCounts = new MergeActionCounts(inserted, updated, deleted);
        return mergeCounts;
...
#pragma warning restore CA2007
    ...
    /// <summary> Updates the entities' identity field </summary>
...
#pragma warning restore CA2007
    ...
    /// <summary> Queries the output table data </summary>
