...
public sealed class FastProperty
{
    ...
    {
        FastProperty result = FastPropertyCache.GetOrAdd(property, p => new FastProperty(p));
        return result;
    }
    ...
    private void InitializeSet()
    {
        ...
        MethodInfo? setter = Property.GetSetMethod(true) ?? Property.DeclaringType?.GetProperty(Property.Name)?.GetSetMethod(true); // when Prop from parent it requires DeclaringType
    ...
    private void InitializeGet()
    {
        ...
        MethodInfo? getter = Property.GetGetMethod(true) ?? Property.DeclaringType.GetProperty(Property.Name)?.GetGetMethod(true);
