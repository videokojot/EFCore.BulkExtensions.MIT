...
public class BulkConfig
{
    ...
    /// </summary>
    public List<BulkCopyColumnOrderHint>? BulkCopyColumnOrderHints { get; set; }
    ...
    public object? SynchronizeFilter { get; private set; }

    public bool OutputTableHasSqlActionColumn => CalculateStats
    ...
    public bool LoadOnlyIdsWhenSettingOutputIdentity => SetOutputIdentity && !SetOutputNonIdentityColumns;

    public bool UseOriginalIndexToIdentityMappingColumn => LoadOnlyIdsWhenSettingOutputIdentity;
}
